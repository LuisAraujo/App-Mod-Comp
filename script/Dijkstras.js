    ...
    **/
    Dijkstras.prototype.setGraph = function (graph)
    {
        ...
        for (var index in graph) {
			...
			//incorporando a posicao gps
			this.graph[nodeName]["Lat"] =  latNode;
            this.graph[nodeName]["Log"] = logNode;
    ...
    Dijkstras.prototype.getPath = function (source, target)
    {
        ...
        while (u = this.queue.shift()) {
            ...
            if (u === target) {
				...
				//retrorna dois Array, um com Longitude e Latitude do Nó e outro como o Melhor Caminho
				r = [  [source, this.graph[source]["Lat"], this.graph[source]["Log"] ],path]
                return r;
            }
